...
| `garment-exp-0011` | Representation Adaptation Pilot | `google/siglip-so400m-patch14-384` | `v0.3.0` (Prod Manifest v1.0) | Layer 26 + Post LayerNorm Adapted ($\text{lr}=10^{-5}$) + 256-d Probe (Phase 11J) | NVIDIA GTX 1650 (4GB) / CUDA 12.6 / PyTorch 2.13 | ~25s (20 epochs, 240 steps) | 0.1667 ($N=20$, Measured) | 0.3500 ($N=20$, Measured) | 0.1111 ($N=18$, Measured) | 0.1250 ($N=16$, Measured) | **REAL REPRESENTATION ADAPTATION PILOT VERIFIED** | `sha256:60f0a9f05c17d0e2...` |
